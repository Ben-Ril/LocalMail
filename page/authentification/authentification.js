...
function onload(){
    ...
    if (screenSizeWidth < screenSizeHeight){
        document.getElementById("body").style.backgroundImage = "url('../img/backgroundAuthentificationRotate.webp')"
        console.log("coucou")
    }
    else{
        document.getElementById("body").style.backgroundImage = "url('../img/backgroundAuthentification.webp')"
    }
